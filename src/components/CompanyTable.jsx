              ...
              <tbody className="divide-y divide-gray-200">
                {companies.map((company, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="p-4 text-left whitespace-nowrap">{index + 1}</td>
                    <td className="p-4 text-left whitespace-nowrap">{company.registrationNo}</td>
                    ...
                    <td className="p-4 text-left whitespace-nowrap">{company.organizationType}</td>
