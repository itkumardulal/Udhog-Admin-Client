  ...
  const newsList = [
    {
      ...
      date: 'June 20, 2025',
      description:
        'This is the detailed news about the Annual Business Expo happening this year with various exhibitors and sessions.',
      imageUrl: image,
    },
      ...
      {!selectedNews ? (
        <>
          <div className="mb-8">
            ...
            <p className="text-base text-gray-600 mt-2">Explore the latest updates and announcements.</p>
          </div>
            ...
            {newsList.map((news) => (
              ...
              >
                <div className="mb-4 sm:mb-0">
                  <p className="text-lg sm:text-xl font-semibold text-gray-900">{news.title}</p>
                  <p className="text-sm text-gray-500 mt-1">{news.date}</p>
                </div>

                <div className="flex space-x-3">
                  {/* View Button */}
                  <button onClick={() => setSelectedNews(news)} title="View" className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-gray-200 flex items-center">
                    <svg
                  ...
                  {/* Delete Button */}
                  <button className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex items-center" title="Delete">
                    <svg
        ...
        <div className="space-y-6 flex-grow overflow-auto">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">{selectedNews.title}</h2>
          ...
          <p className="text-sm text-gray-500 mt-4">Published: {selectedNews.date}</p>
        </div>
      )}
    </div>
  );
